...
#this script will run through the entire message and count each character in it
...
#pretty print function (formats the dictionary cleanly and sorts): pprint.pprint(count)
